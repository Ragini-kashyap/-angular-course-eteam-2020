...
export class AddContactComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.addContactForm = new FormGroup({
      ...
      name: new FormControl('ragini', Validators.required), // Step 5: work on validations
      phone: new FormControl('45454', Validators.required),
      email: new FormControl('ragini@gmail.com', [Validators.required, Validators.email])
    });
  }
